...
class GeneSearchForm(Form):
	gene_name = StringField('gene_symbol',validators=[DataRequired()],render_kw={'placeholder':'Enter gene symbol','href':"javascript://",'onkeyup':"Sijax.request('testing',[$('#gene_name').attr('value')]);"})
